import {
	...
	PUBLIC_QUALITY_MONITORING_ADDRESS,
	PUBLIC_LOGISTICS_TRACKING_ADDRESS,
	PUBLIC_MARKETPLACE_ADDRESS,
...
export const CONFIG = {
	...
	contracts: {
		...
		qualityMonitoring: PUBLIC_QUALITY_MONITORING_ADDRESS,
		logisticsTracking: PUBLIC_LOGISTICS_TRACKING_ADDRESS,
		marketplace: PUBLIC_MARKETPLACE_ADDRESS
	},
