...
|                                  | 5.3 Decentralized Storage                       | Integration with IPFS andArweave for storing larger off-chain files linked to NFTs (i.e., high-resolution images, detailed certifications).                                                         | Provides a scalable solution for data too large for direct on-chain storage, with cryptographic links from Massa NFTs.                                        |
